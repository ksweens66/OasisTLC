...
const int       thermistor_count = 9;                 // number of heaters  
const int       middle_index = 4;                     // 0...8 is 4. The index of the middle of the array of temps. Ex. for 3 thermistors we have 0,1,2. Middle is 1.
